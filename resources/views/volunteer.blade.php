...
@section('heroSection')
    <div class="rpll-hero-layout-1__image-wrapper">
        <picture class='rpla-art-directed-image rpla-art-directed-image--permit-upscaling'>
            <source srcset="{{ asset('assets/images/volunteer_hero_primary.jpg') }}" media="all and (min-width: 64.063em)">
            <source srcset="{{ asset('assets/images/volunteer_hero_primary.jpg') }}"
                media="all and (min-width: 26em) and (max-width: 64em)">
            <source srcset="{{ asset('assets/images/volunteer_hero_secondary.jpg') }}">
            <img src="{{ asset('assets/images/volunteer_hero_secondary.jpg') }}" alt="Hero Background" />
        </picture>
    </div>
@endsection
